...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_user', (
            ...
            ('facebook_id', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('twitter_username', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('skype_username', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('aim_username', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('gtalk_username', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('windows_live_id', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('last_ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15, blank=True, default='127.0.0.1', null=True)),
            ('timezone', self.gf('django.db.models.fields.CharField')(max_length=255, default='UTC')),
            ('token_version', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
        ))
