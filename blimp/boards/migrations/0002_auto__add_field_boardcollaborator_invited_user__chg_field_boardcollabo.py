...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('boards_boardcollaborator', 'invited_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['invitations.InvitedUser'], null=True),
                      keep_default=False)


        # Changing field 'BoardCollaborator.user'
        db.alter_column('boards_boardcollaborator', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User'], null=True))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'BoardCollaborator.user'
        raise RuntimeError("Cannot reverse this migration. 'BoardCollaborator.user' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'BoardCollaborator.user'
        db.alter_column('boards_boardcollaborator', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User']))
    ...
    models = {
        ...
        'boards.boardcollaborator': {
            'Meta': {'ordering': "('-date_modified', '-date_created')", 'object_name': 'BoardCollaborator'},
