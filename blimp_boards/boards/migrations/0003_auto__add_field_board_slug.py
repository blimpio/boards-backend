...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('boards_board', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='board-1393272775', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Board.slug'
        db.delete_column('boards_board', 'slug')
    ...
    models = {
        ...
        'invitations.inviteduser': {
            ...
            'account': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.Account']"}),
            'board_collaborators': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'null': 'True', 'symmetrical': 'False', 'to': "orm['boards.BoardCollaborator']"}),
        ...
        'users.user': {
            ...
            'token_version': ('django.db.models.fields.CharField', [], {'default': "'6342ad8b-af16-4e30-8a8a-6c54f768f2d2'", 'unique': 'True', 'db_index': 'True', 'max_length': '36'}),
