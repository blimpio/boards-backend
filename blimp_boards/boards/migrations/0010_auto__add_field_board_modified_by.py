...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Board.modified_by'
        db.add_column('boards_board', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='board_modified_by', null=True, to=orm['users.User'], blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Board.modified_by'
        db.delete_column('boards_board', 'modified_by_id')
    ...
    models = {
        ...
        'boards.board': {
            ...
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'board_modified_by'", 'null': 'True', 'to': "orm['users.User']", 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
        ...
        'users.user': {
            ...
            'token_version': ('django.db.models.fields.CharField', [], {'max_length': '36', 'default': "'abd5321e-b3d4-4844-8b93-bc972db29238'", 'unique': 'True', 'db_index': 'True'}),
