...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Board.modified_by'
        db.alter_column('boards_board', 'modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['users.User']))

    def backwards(self, orm):

        # Changing field 'Board.modified_by'
        db.alter_column('boards_board', 'modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User'], null=True))
    ...
    models = {
        ...
        'users.user': {
            ...
            'token_version': ('django.db.models.fields.CharField', [], {'unique': 'True', 'default': "'96dd0ef1-5786-45b5-a689-3007ab86c918'", 'db_index': 'True', 'max_length': '36'}),
