...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('boards_board', 'slug', self.gf('autoslug.fields.AutoSlugField')(populate_from=None, max_length=50, unique_with=()))

    def backwards(self, orm):

        # Changing field 'Board.slug'
        db.alter_column('boards_board', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
    ...
    models = {
        ...
        'boards.board': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'slug': ('autoslug.fields.AutoSlugField', [], {'populate_from': 'None', 'max_length': '50', 'unique_with': '()'}),
        ...
        'invitations.inviteduser': {
            ...
            'account': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.Account']"}),
            'board_collaborators': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'null': 'True', 'to': "orm['boards.BoardCollaborator']", 'blank': 'True'}),
        ...
        'users.user': {
            ...
            'token_version': ('django.db.models.fields.CharField', [], {'default': "'36fee21a-5019-41ff-991a-49ab5dfc7ce8'", 'db_index': 'True', 'max_length': '36', 'unique': 'True'}),
