...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for board in orm['boards.Board'].objects.all():
            board.modified_by = board.created_by
            board.save()
    ...
    models = {
        'accounts.account': {
            ...
            'slug': ('autoslug.fields.AutoSlugField', [], {'populate_from': "'name'", 'unique_with': '()', 'unique': 'True', 'max_length': '50', 'blank': 'True'}),
        ...
        'users.user': {
            ...
            'token_version': ('django.db.models.fields.CharField', [], {'default': "'e0b60473-768a-415c-8400-bcbc1558119c'", 'unique': 'True', 'db_index': 'True', 'max_length': '36'}),
