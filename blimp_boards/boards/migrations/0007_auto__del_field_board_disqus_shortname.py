...
class Migration(SchemaMigration):
    ...
    models = {
        'accounts.account': {
            ...
            'email_domains': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['accounts.EmailDomain']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logo_color': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'slug': ('autoslug.fields.AutoSlugField', [], {'populate_from': "'name'", 'max_length': '50', 'unique_with': '()', 'unique': 'True'})
        },
        ...
        'invitations.inviteduser': {
            ...
            'account': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.Account']"}),
            'board_collaborators': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['boards.BoardCollaborator']", 'null': 'True', 'blank': 'True'}),
        ...
        'users.user': {
            ...
            'token_version': ('django.db.models.fields.CharField', [], {'default': "'3da62440-f815-40d7-ad7a-aff070c82cb5'", 'max_length': '36', 'unique': 'True', 'db_index': 'True'}),
