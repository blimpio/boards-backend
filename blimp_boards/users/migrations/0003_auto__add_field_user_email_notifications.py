...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.email_notifications'
        db.add_column('users_user', 'email_notifications',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.email_notifications'
        db.delete_column('users_user', 'email_notifications')
    ...
    models = {
        'users.user': {
            ...
            'token_version': ('django.db.models.fields.CharField', [], {'max_length': '36', 'default': "'199713d6-718d-4ba6-8279-907eda0e4602'", 'unique': 'True', 'db_index': 'True'}),
