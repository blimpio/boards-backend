...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('users_user', 'phone')


    def backwards(self, orm):
        # Adding field 'User.phone'
        db.add_column('users_user', 'phone',
                      self.gf('django.db.models.fields.CharField')(max_length=40, blank=True, default=''),
                      keep_default=False)
    ...
    models = {
        'users.user': {
            ...
            'token_version': ('django.db.models.fields.CharField', [], {'max_length': '36', 'db_index': 'True', 'default': "'61add8dd-4a93-4282-9607-08686457993e'", 'unique': 'True'}),
