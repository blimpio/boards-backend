...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.modified_by'
        db.add_column('comments_comment', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User'], blank=True, related_name='comment_modified_by', null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.modified_by'
        db.delete_column('comments_comment', 'modified_by_id')
    ...
    models = {
        'comments.comment': {
            ...
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.User']", 'blank': 'True', 'related_name': "'comment_modified_by'", 'null': 'True'}),
        ...
        'users.user': {
            ...
            'token_version': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '36', 'unique': 'True', 'default': "'2f02dd11-49f5-4eb2-93c2-624ac50792f0'"}),
