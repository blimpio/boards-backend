...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Comment.modified_by'
        db.alter_column('comments_comment', 'modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User'], default=1))

    def backwards(self, orm):

        # Changing field 'Comment.modified_by'
        db.alter_column('comments_comment', 'modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['users.User']))
    ...
    models = {
        'comments.comment': {
            ...
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.User']", 'related_name': "'comment_modified_by'"}),
        ...
        'users.user': {
            ...
            'token_version': ('django.db.models.fields.CharField', [], {'unique': 'True', 'default': "'80efd3cc-839d-49f5-899e-46527224a460'", 'max_length': '36', 'db_index': 'True'}),
