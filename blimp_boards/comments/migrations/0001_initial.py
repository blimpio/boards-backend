...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('comments_comment', (
            ...
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User'], related_name='comment_modified_by')),
    ...
    models = {
        ...
        'users.user': {
            ...
            'token_version': ('django.db.models.fields.CharField', [], {'default': "'99c0111a-7246-476a-9d56-5a0aa2ce1e6a'", 'max_length': '36', 'unique': 'True', 'db_index': 'True'}),
