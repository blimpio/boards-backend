...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('accounts_account', 'type',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('accounts_account', 'type')
    ...
    models = {
        'accounts.account': {
            ...
            'email_domains': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['accounts.EmailDomain']", 'blank': 'True', 'null': 'True'}),
        ...
        'users.user': {
            ...
            'token_version': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'unique': 'True', 'max_length': '36', 'default': "'48b4b2b6-1f46-4ea4-8b3a-b897fd80276c'"}),
