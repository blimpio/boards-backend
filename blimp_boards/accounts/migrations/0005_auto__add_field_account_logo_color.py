...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.logo_color'
        db.add_column('accounts_account', 'logo_color',
                      self.gf('django.db.models.fields.CharField')(default='red', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.logo_color'
        db.delete_column('accounts_account', 'logo_color')
    ...
    models = {
        'accounts.account': {
            ...
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique': 'True', 'max_length': '50', 'unique_with': '()', 'populate_from': "'name'"})
        },
        ...
        'users.user': {
            ...
            'token_version': ('django.db.models.fields.CharField', [], {'default': "'db24fc9c-02e4-4c68-bbb6-9c3082d40d8f'", 'unique': 'True', 'max_length': '36', 'db_index': 'True'}),
