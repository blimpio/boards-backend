...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('accounts_account', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, populate_from='name', unique=True, unique_with=()))
        # Adding unique constraint on 'Account', fields ['slug']
        db.create_unique('accounts_account', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Account', fields ['slug']
        db.delete_unique('accounts_account', ['slug'])


        # Changing field 'Account.slug'
        db.alter_column('accounts_account', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
    ...
    models = {
        'accounts.account': {
            ...
            'slug': ('autoslug.fields.AutoSlugField', [], {'max_length': '50', 'populate_from': "'name'", 'unique': 'True', 'unique_with': '()'})
        },
        ...
        'users.user': {
            ...
            'token_version': ('django.db.models.fields.CharField', [], {'default': "'3f399220-964f-4750-9f71-21a274dc519c'", 'max_length': '36', 'unique': 'True', 'db_index': 'True'}),
