...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cards_card', 'stack',
                      self.gf('django.db.models.fields.related.ForeignKey')(null=True, related_name='+', blank=True, to=orm['cards.Card']),
                      keep_default=False)
    ...
    models = {
        ...
        'cards.card': {
            ...
            'cards': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'related_name': "'+'", 'symmetrical': 'False', 'blank': 'True', 'to': "orm['cards.Card']"}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_shared': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'mime_type': ('django.db.models.fields.CharField', [], {'null': 'True', 'max_length': '40', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'origin_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique_with': "('board',)", 'max_length': '50', 'populate_from': "'name'", 'blank': 'True'}),
        ...
        'users.user': {
            ...
            'token_version': ('django.db.models.fields.CharField', [], {'unique': 'True', 'db_index': 'True', 'max_length': '36', 'default': "'8b73be02-4923-48a9-99ed-63257a0d2557'"}),
