...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Card.file_extension'
        db.delete_column('cards_card', 'file_extension')

        # Adding field 'Card.mime_type'
        db.add_column('cards_card', 'mime_type',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Card.file_extension'
        db.add_column('cards_card', 'file_extension',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank=True),
                      keep_default=False)

        # Deleting field 'Card.mime_type'
        db.delete_column('cards_card', 'mime_type')
    ...
    models = {
        'accounts.account': {
            ...
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique_with': '()', 'max_length': '50', 'unique': 'True', 'populate_from': "'name'"})
        },
        ...
        'boards.board': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'slug': ('autoslug.fields.AutoSlugField', [], {'max_length': '50', 'unique_with': "('account',)", 'populate_from': "'name'"}),
        ...
        'cards.card': {
            ...
            'cards': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['cards.Card']", 'symmetrical': 'False', 'null': 'True', 'blank': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_shared': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'mime_type': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'origin_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'slug': ('autoslug.fields.AutoSlugField', [], {'max_length': '50', 'unique_with': "('board',)", 'blank': 'True', 'populate_from': "'name'"}),
            'thumbnail_lg_path': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'thumbnail_md_path': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'thumbnail_sm_path': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        'users.user': {
            ...
            'token_version': ('django.db.models.fields.CharField', [], {'default': "'ab293c80-c4a4-4e1b-9b6e-4fc1f245e118'", 'max_length': '36', 'unique': 'True', 'db_index': 'True'}),
