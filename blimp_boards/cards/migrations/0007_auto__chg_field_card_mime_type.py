...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cards_card', 'mime_type', self.gf('django.db.models.fields.CharField')(max_length=40, default=''))

    def backwards(self, orm):

        # Changing field 'Card.mime_type'
        db.alter_column('cards_card', 'mime_type', self.gf('django.db.models.fields.CharField')(null=True, max_length=40))
    ...
    models = {
        'accounts.account': {
            ...
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique': 'True', 'unique_with': '()', 'max_length': '50', 'populate_from': "'name'"})
        },
        ...
        'cards.card': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_shared': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'mime_type': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '40'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
        ...
        'users.user': {
            ...
            'token_version': ('django.db.models.fields.CharField', [], {'unique': 'True', 'db_index': 'True', 'max_length': '36', 'default': "'168759b1-dc68-42a4-9197-6a7d39e972e4'"}),
