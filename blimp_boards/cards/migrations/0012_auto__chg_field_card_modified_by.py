...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Card.modified_by'
        db.alter_column('cards_card', 'modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['users.User']))

    def backwards(self, orm):

        # Changing field 'Card.modified_by'
        db.alter_column('cards_card', 'modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['users.User']))
    ...
    models = {
        ...
        'cards.card': {
            ...
            'cards': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'related_name': "'+'", 'symmetrical': 'False', 'to': "orm['cards.Card']", 'blank': 'True'}),
            ...
            'stack': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'+'", 'to': "orm['cards.Card']", 'blank': 'True'}),
            'thumbnail_lg_path': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'thumbnail_md_path': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'thumbnail_sm_path': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        'users.user': {
            ...
            'token_version': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'unique': 'True', 'max_length': '36', 'default': "'c417227e-8cf8-4596-984f-957ff14ca0be'"}),
